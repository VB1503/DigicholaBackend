...
from .models import User, BusinessUser, Category, BusinessDetails
...
class UserRegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=User
        fields = ['email',"phone_number", 'first_name', 'last_name', 'password', 'password2','id']
...
class BusinessUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = BusinessUser
        fields = ['user', 'phone_number', 'priority', 'full_name']
